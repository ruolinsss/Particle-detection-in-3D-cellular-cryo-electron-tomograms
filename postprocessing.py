...
from postprocessing.helper import find_center,get_center_coords,remove_outlier
from skimage.morphology import remove_small_objects  

pred_mask_path = '/home/haicu/ruolin.shen/projects/train/tomo17_processed_d.mrc' 
pred_center_path = '/home/haicu/ruolin.shen/projects/train/tomo17_center.mrc' 
pred_path = '.output/'
voxel_size = 14.08 # voxel size for different dataset, 14.08 for spinach data

mask = read_mrc(pred_mask_path)
center = read_mrc(pred_center_path)
...
write_mrc(processed_mask,pred_path+'pred_tomo.mrc')
